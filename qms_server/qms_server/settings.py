...
CHECKING_SERVICES_PROCESSES_AMOUNT = os.getenv('CHECKING_SERVICES_PROCESSES_AMOUNT', '5')
CHECKING_SERVICES_PROCESSES_AMOUNT = int(CHECKING_SERVICES_PROCESSES_AMOUNT)
